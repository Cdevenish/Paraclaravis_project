...
source("J:/MMU/R/functions_etc/repos/R-Material/Functions/GIS/adjExt.r")
...
# ## kernel density
# library(spatialEco) -- didn't work....
# ?sp.kde()
# 
# kde <- sp.kde(as(ebird.aoi, "Spatial"), bw = 1000, newdata = msk.aoi, standardize = TRUE, scale.factor = 10000)
# # plot(kde)


## in arcgis. band width was 24957.19 m  - default - by SIlverman'#s rule
